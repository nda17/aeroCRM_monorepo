...
export const SLA_EXCHANGE = 'aerocrm.crm-intake.sla.events';
export const SLA_DEAD_EXCHANGE = 'aerocrm.crm-intake.sla.dead-letter';
export const SLA_QUEUE = 'aerocrm.crm-intake.sla.v1';
