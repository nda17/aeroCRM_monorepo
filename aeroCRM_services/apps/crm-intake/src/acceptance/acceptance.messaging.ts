...
export function intakeProcessRole(): IntakeProcessRole {
	...
	if (
		...
		throw new Error(
			'CRM_INTAKE_PROCESS_ROLE must be api, worker, publisher, all, sla-worker or sla-publisher'
		);
...
export const ACCEPTANCE_EXCHANGE = 'aerocrm.crm-intake.events';
export const ACCEPTANCE_DEAD_EXCHANGE = 'aerocrm.crm-intake.dead-letter';
export const ACCEPTANCE_QUEUE = 'aerocrm.crm-intake.acceptance.v1';
