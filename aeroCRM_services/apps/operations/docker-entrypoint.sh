...
readonly runtime_key_directory='/run/aerocrm-operations-secrets'
readonly runtime_key_file='/run/aerocrm-operations-secrets/database-backup-provenance-private-key.pem'
