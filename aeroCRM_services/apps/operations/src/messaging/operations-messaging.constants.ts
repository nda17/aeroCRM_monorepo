export const OPERATIONS_EVENTS_EXCHANGE = 'aerocrm.events';
export const OPERATIONS_RETRY_EXCHANGE = 'aerocrm.retry';
export const OPERATIONS_DEAD_LETTER_EXCHANGE = 'aerocrm.dead-letter';
export const OPERATIONS_MANUAL_RETRY_EXCHANGE = 'aerocrm.manual-retry';
...
export const OPERATIONS_SCHEDULED_JOB_QUEUE =
	'aerocrm.operations.scheduled-jobs.v1';
...
export const OPERATIONS_DATABASE_RESTORE_QUEUE =
	'aerocrm.operations.database-restore.v1';
...
export function getOperationsAuditQueue(source: OperationsAuditSource) {
	return `aerocrm.operations.admin.audit.${source.source}.v1`;
}
