...
import { TurnstileAction, TurnstileGuard } from './turnstile.guard';
import { RefreshTokenService } from './refresh-token.service';

const PUBLIC_GUARDS = [AuthRateLimitGuard, TurnstileGuard];
...
export class AuthController {
	...
	@HttpCode(200)
	@UseGuards(...PUBLIC_GUARDS)
	@TurnstileAction('email_register')
	@UsePipes(new ValidationPipe({ whitelist: true }))
	async registerEmail(
	...
	@HttpCode(200)
	@UseGuards(...PUBLIC_GUARDS)
	@TurnstileAction('email_resend_code')
	@UsePipes(new ValidationPipe({ whitelist: true }))
	...
	@HttpCode(200)
	@UseGuards(...PUBLIC_GUARDS)
	@TurnstileAction('phone_send_code')
	@UsePipes(new ValidationPipe({ whitelist: true }))
	...
	@HttpCode(200)
	@UseGuards(...PUBLIC_GUARDS)
	@TurnstileAction('phone_register')
	@UsePipes(new ValidationPipe({ whitelist: true }))
	async registerPhone(
	...
	@HttpCode(200)
	@UseGuards(...PUBLIC_GUARDS)
	@TurnstileAction('restore_password')
	@UsePipes(new ValidationPipe({ whitelist: true }))
