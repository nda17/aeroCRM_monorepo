...
describe('Workday export v2 metadata security', () => {
	...
	it.each([
		...
		['X-CRM-Export-Schema', '3'],
		['X-CRM-Export-Actor-SHA256', 'b'.repeat(64)],
		['X-CRM-Workspace-Id', otherId],
		['X-CRM-Export-Entity', 'deals'],
		['X-CRM-Export-Rows', '10001'],
		['X-CRM-Export-Rows', '-1'],
		['X-CRM-Export-Rows', '01'],
		['X-CRM-Export-Bytes', String(WORKDAY_EXPORT_MAX_BYTES + 1)],
		['X-CRM-Export-Bytes', '0'],
		['X-CRM-Export-Snapshot-At', '2026-02-30T00:00:00.000Z'],
