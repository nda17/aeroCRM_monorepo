		...
		<section className={styles.wrapper}>
			...
			{restoreTargetId && isDev && (
				<ConfirmDialog
					...
					message={`Запись пользователя ${restoreTargetLabel} снова станет видна администраторам. Аккаунт останется деактивированным: доступ и старые сессии автоматически не восстановятся.`}
